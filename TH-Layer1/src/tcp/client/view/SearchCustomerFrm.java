...
public class SearchCustomerFrm extends JFrame implements ActionListener{
        ...
        tblResult.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                if (row < tblResult.getRowCount() && row >= 0 && column < tblResult.getColumnCount() && column >= 0) {
                    ...
                    //create new instance
                    customer = listClient.get(row);
                    (new SearchProductFrm(mySocket,customer)).setVisible(true);
                    dispose();
                }
            }
        });
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(btnClicked.equals(btnSearch)){
            ...
            mySocket.sendData(new ObjectWrapper(ObjectWrapper.SEARCH_CUSTOMER_BY_ID, txtKey.getText().trim()));
        }
    }
